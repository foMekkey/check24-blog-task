...
class AppServiceProvider
{
    ...
    protected function register()
    {
        ...
        $this->serviceProvider->addInstance(CommentsInterface::class, new CommentRepository($this->serviceProvider->get(DBInterface::class)));
        $this->serviceProvider->addInstance(CommentsService::class, new CommentsServiceImpl);
    }
